          ...
          '/docs/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Подключение Email', link: '/docs/email' },
                { text: 'Подключение Avito', link: '/docs/avito' },
          ...
          '/en/docs/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Connecting Email', link: '/en/docs/email' },
                { text: 'Connecting Avito', link: '/en/docs/avito' },
